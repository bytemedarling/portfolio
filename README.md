...
# Projects
A showcase of selected projects, including:

- Project title and short description
- Tech stack used (e.g., HTML, CSS, JavaScript)
...
- ARIA landmarks only when necessary
- Alt text for informative images
- Labels and aria-describedby for form fields
- Sufficient color contrast and visible focus outlines
